...
export default function Product({
                ...
                <div className="mx-auto max-w-7xl">
                    <div className="overflow-hidden rounded-3xl border border-gray-200 bg-white shadow-sm">
                        <div className="grid grid-cols-1 lg:grid-cols-2">
                            ...
                            {/* IMAGE SKELETON */}
                            <div className="aspect-square animate-pulse bg-gray-200 lg:aspect-auto lg:min-h-[650px]" />

                            {/* CONTENT SKELETON */}
                            <div className="space-y-5 p-5 sm:p-8 lg:p-12">
    ...
    const payablePrice = Number(product.payable_price || 0);
                        ...
                        <div className="flex flex-col p-5 sm:p-8 lg:p-12">
                            ...
                            <div className="mt-6 rounded-2xl border border-gray-100 p-4">
                                ...
                                <p className="mt-1 text-xs text-gray-500">
                                    We can help with availability,
                                    sizes, colors and ordering.
                                </p>
